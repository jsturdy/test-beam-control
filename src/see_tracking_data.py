...
# Design
window.printBox(0, 9, 40, "BC: ", "Default", "right")
window.printBox(0, 10, 40, "EC: ", "Default", "right")
window.printBox(0, 11, 40, "ChipID: ", "Default", "right")
window.printBox(0, 12, 40, "Data 1: ", "Default", "right")
window.printBox(0, 13, 40, "Data 2: ", "Default", "right")
window.printBox(0, 14, 40, "Data 3: ", "Default", "right")
window.printBox(0, 15, 40, "Data 4: ", "Default", "right")
window.printBox(0, 16, 40, "CRC: ", "Default", "right")
window.printBox(0, 17, 40, "BX: ", "Default", "right")
...
while(True):
    ...
    window.printBox(40, 15, 40, "", "Default", "left")
    window.printBox(40, 16, 40, "", "Default", "left")
    window.printBox(40, 17, 40, "", "Default", "left")
    ...
    window.printBox(40, 9, 40, bc, "Default", "left")
    window.printBox(40, 10, 40, ec, "Default", "left")
    window.printBox(40, 11, 40, chipid, "Default", "left")
    window.printBox(40, 12, 40, data1, "Default", "left")
    window.printBox(40, 13, 40, data2, "Default", "left")
    window.printBox(40, 14, 40, data3, "Default", "left")
    window.printBox(40, 15, 40, data4, "Default", "left")
    window.printBox(40, 16, 40, crc, "Default", "left")
    window.printBox(40, 17, 40, bx, "Default", "left")
