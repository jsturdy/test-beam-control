...
# Design
window.printLine(7, "Select the VFAT2s you want to stop (1 or 0)", "Info", "center")
...
# Design
window.printLine(16, "Press [s] to stop the VFAT2s or [ctrl+c] to quit", "Info", "center")
...
# Start the VFAT2
if (n8 == 1):
    glib.setVFAT2(8, 'ctrl0', 0x36)
if (n9 == 1):
    glib.setVFAT2(9, 'ctrl0', 0x36)
if (n10 == 1):
    glib.setVFAT2(10, 'ctrl0', 0x36)
if (n11 == 1):
    glib.setVFAT2(11, 'ctrl0', 0x36)
if (n12 == 1):
    glib.setVFAT2(12, 'ctrl0', 0x36)
if (n13 == 1):
    glib.setVFAT2(13, 'ctrl0', 0x36)

# Design
window.printLine(17, "VFAT2s stopped", "Success", "center")
