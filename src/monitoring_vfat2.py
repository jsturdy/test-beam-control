...
def mainWindow(vfat2ID):
    ...
    window.printLine(3, "recommended value for data tacking.", "Warning")
    ...
    while (True):
        ...
        if (len(vfat2Registers) != 0):
            ...
            #
            window.printLabel(0, 5, 24, "Control 0:", vfat2Registers["ctrl0"], ("Error" if (vfat2Registers["ctrl0"] != 55) else "Success"))
            window.printLabel(0, 6, 24, "Control 1:", vfat2Registers["ctrl1"], ("Error" if (vfat2Registers["ctrl1"] != 0) else "Success"))
            window.printLabel(0, 7, 24, "Control 2:", vfat2Registers["ctrl2"], ("Error" if (vfat2Registers["ctrl2"] != 48) else "Success"))
            window.printLabel(0, 8, 24, "Control 3:", vfat2Registers["ctrl3"], ("Error" if (vfat2Registers["ctrl3"] != 0) else "Success"))
            window.printLabel(0, 9, 24, "Chip ID 0:", vfat2Registers["chipid0"])
            window.printLabel(0, 10, 24, "Chip ID 1:", vfat2Registers["chipid1"])
            window.printLabel(27, 5, 24, "IPreampIn:", vfat2Registers["ipreampin"], ("Error" if (vfat2Registers["ipreampin"] != 168) else "Success"))
            window.printLabel(27, 6, 24, "IPreampFeed:", vfat2Registers["ipreampfeed"], ("Error" if (vfat2Registers["ipreampfeed"] != 80) else "Success"))
            window.printLabel(27, 7, 24, "IPreampOut:", vfat2Registers["ipreampout"], ("Error" if (vfat2Registers["ipreampout"] != 150) else "Success"))
            window.printLabel(27, 8, 24, "IShaper:", vfat2Registers["ishaper"], ("Error" if (vfat2Registers["ishaper"] != 150) else "Success"))
            window.printLabel(27, 9, 24, "IShaperFeed:", vfat2Registers["ishaperfeed"], ("Error" if (vfat2Registers["ishaperfeed"] != 100) else "Success"))
            window.printLabel(27, 10, 24, "IComp:", vfat2Registers["icomp"], ("Error" if (vfat2Registers["icomp"] != 75) else "Success"))
            window.printLabel(54, 5, 24, "VThreshold 1:", vfat2Registers["vthreshold1"])
            window.printLabel(54, 6, 24, "VThreshold 2:", vfat2Registers["vthreshold2"], ("Error" if (vfat2Registers["vthreshold2"] != 0) else "Success"))
            window.printLabel(54, 7, 24, "VCal:", vfat2Registers["vcal"])
            window.printLabel(54, 8, 24, "Calphase:", vfat2Registers["calphase"])
            window.printLabel(54, 9, 24, "Latency:", vfat2Registers["latency"], ("Error" if (vfat2Registers["latency"] != 10) else "Success"))
...
def setRegistersWindow(vfat2ID):
    ...
    vfat2Registers = glib.saveVFAT2(vfat2ID)
    #
    ctrl0 = window.inputIntShifted(0, 5, "Control 0:", 3, 0, 255, vfat2Registers["ctrl0"])
    ctrl1 = window.inputIntShifted(0, 6, "Control 1:", 3, 0, 255, vfat2Registers["ctrl1"])
    ctrl2 = window.inputIntShifted(0, 7, "Control 2:", 3, 0, 255, vfat2Registers["ctrl2"])
    ctrl3 = window.inputIntShifted(0, 8, "Control 3:", 3, 0, 255, vfat2Registers["ctrl3"])
    ipreampin = window.inputIntShifted(27, 5, "IPreampIn:", 3, 0, 255, vfat2Registers["ipreampin"])
    ipreampfeed = window.inputIntShifted(27, 6, "IPreampFeed:", 3, 0, 255, vfat2Registers["ipreampfeed"])
    ipreampout = window.inputIntShifted(27, 7, "IPreampOut:", 3, 0, 255, vfat2Registers["ipreampout"])
    ishaper = window.inputIntShifted(27, 8, "IShaper:", 3, 0, 255, vfat2Registers["ishaper"])
    ishaperfeed = window.inputIntShifted(27, 9, "IShaperFeed:", 3, 0, 255, vfat2Registers["ishaperfeed"])
    icomp = window.inputIntShifted(27, 10, "IComp:", 3, 0, 255, vfat2Registers["icomp"])
    vthreshold1 = window.inputIntShifted(54, 5, "VThreshold 1:", 3, 0, 255, vfat2Registers["vthreshold1"])
    vthreshold2 = window.inputIntShifted(54, 6, "VThreshold 2:", 3, 0, 255, vfat2Registers["vthreshold2"])
    ...
    latency = window.inputIntShifted(54, 9, "Latency:", 3, 0, 255, vfat2Registers["latency"])
    #
